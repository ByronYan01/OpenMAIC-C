...
export const generationEnUS = {
  ...
  upload: {
    pdfSizeLimit: 'Supports PDF files up to 200MB',
    ...
    fileTooLarge: 'File too large. Please select a PDF file smaller than 200MB',
  },
  generation: {
    // Progress steps (used dynamically via activeStep)
