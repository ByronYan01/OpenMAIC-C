...
export const stageEnUS = {
  stage: {
    ...
    invalidSlideContent: 'Invalid slide content',
    invalidQuizContent: 'Invalid quiz content',
    invalidInteractiveContent: 'Invalid interactive content',
    invalidPblContent: 'Invalid PBL content',
